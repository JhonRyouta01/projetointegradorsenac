...
public class UsuarioDAO extends DAO<Usuario> {
    ...
    public void salvar(Usuario usuario) {
        ...
        try {
            String query;
            if (usuario.getId() == 0) {
                query = "INSERT INTO usuarioLog(nome , senha) values (?, ?) ;";
            } else {
                query = "UPDATE usuarioLog SET nome = ? ,  senha = ? where id = ? ; ";
            }
    ...
    public void deletar(Usuario usuario) {
        String query = "DELETE FROM usuarioLog WHERE id = ?";
        Connection connection = null;
    ...
    public List<Usuario> listar() {
        ...
        String query = "SELECT * FROM usuarioLog;";
    ...
    public Usuario get(int id) {
        ...
        Connection connection = null;
        String query = "SELECT * FROM usuarioLog where id = ? ; ";
        try {
            connection = Conexao.getConnection();
            PreparedStatement ps = connection.prepareStatement(query);
            ps.setInt(1, id);
    ...
    public Usuario getByName(String name) {
        ...
        Usuario usuario = null;
        Connection connection = null;
        String query = "SELECT * FROM usuarioLog where nome = ? ; ";
        try {
            connection = Conexao.getConnection();
            PreparedStatement ps = connection.prepareStatement(query);
            ps.setString(1, name);
    ...
    public List<Usuario> getByFiltro(Integer id, String name) {
        ...
        try {
            ...
            StringBuilder sb = new StringBuilder("SELECT * FROM usuarioLog WHERE 1 = 1 ");
